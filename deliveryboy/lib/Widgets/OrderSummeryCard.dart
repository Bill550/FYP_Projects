...
import 'package:deliveryboy/Services/OrdersServices.dart';
          ...
          children: [
            ListTile(
              ...
              leading: CircleAvatar(
                ...
                radius: 14,
                child: _ordersServices.statusIcon(widget.document),
              ),
              title: Text(
                widget.document['orderStatus'],
                style: TextStyle(
                  fontSize: 12,
                  color: _ordersServices.statusColor(widget.document),
            ...
            _ordersServices.statusContainer(widget.document, context),
            Divider(
              height: 3,
              color: Colors.grey,
            ),
