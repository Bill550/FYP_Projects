                            ...
                            ListTile(
                              ...
                              trailing: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Amount: PKR.${document['total'].toStringAsFixed(0)}',
                                    style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: FontWeight.bold,
                                    ),
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    return ListTile(
                                      ...
                                      subtitle: Text(
                                        '${document['products'][index]['qty']} X PKR.${document['products'][index]['price'].toStringAsFixed(0)} = PKR.${document['products'][index]['total'].toStringAsFixed(0)}',
                                        style: TextStyle(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                'PKR.${document['deliveryFee'].toString()}',
                                                style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 12,
                                                ),
